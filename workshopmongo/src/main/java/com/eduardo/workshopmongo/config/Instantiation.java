...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null,simpleDateFormat.parse("05/03/2024"),"adios","indo viajar",maria);
        Post post2 = new Post(null,simpleDateFormat.parse("07/03/2024"),"bao","acordei",maria);
